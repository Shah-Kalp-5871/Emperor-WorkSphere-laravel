<header class="topbar">
  ...
  <div class="topbar-actions">
    ...
    <button class="icon-btn" onclick="window.location.href='{{ url('/employee/tickets') }}'"
      title="Raise Query / Support">
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"
    ...
    <div class="topbar-avatar" onclick="window.location.href='{{ url('/employee/profile/my-profile') }}'"
      style="cursor: pointer;">{{ auth()->user()->initials ?? 'U' }}</div>
  </div>
</header>