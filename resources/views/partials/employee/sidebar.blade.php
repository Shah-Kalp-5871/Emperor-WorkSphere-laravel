...
<aside class="sidebar">
  ...
  <div class="sidebar-user" onclick="window.location.href='{{ url('/employee/profile/my-profile') }}'"
  ...
  <nav class="sidebar-nav">
    ...
    <a class="nav-item {{ request()->is('employee/dashboard*') ? 'active' : '' }}"
    ...
    <a class="nav-item {{ request()->is('employee/calendar*') ? 'active' : '' }}"
      href="{{ url('/employee/calendar') }}">
      <svg class="icon" viewBox="0 0 24 24">
    ...
    <a class="nav-item {{ request()->is('employee/profile*') ? 'active' : '' }}"
      href="{{ url('/employee/profile/my-profile') }}">
      <svg class="icon" viewBox="0 0 24 24">
    ...
    <a class="nav-item {{ request()->is('employee/anonymous-chat*') ? 'active' : '' }}"
      href="{{ url('/employee/anonymous-chat') }}">
      <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
        stroke-linejoin="round">
