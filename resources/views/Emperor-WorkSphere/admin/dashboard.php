    ...
    <div class="page active" id="page-dashboard">
      <div class="section-header">
        <div>
          ...
          <div class="section-sub">Here's what's happening today — Feb 24, 2026</div>
        </div>
        <div class="section-actions">
          <button class="btn btn-ghost btn-sm" onclick="window.location.href='calendar.php'">
      ...
      <div class="grid-2">
        ...
        <div class="card">
          <div class="card-header">
            ...
            <span class="card-action" onclick="window.location.href='projects.php'">View all →</span>
          </div>
          <div class="card-body">
        ...
        <div class="card">
          <div class="card-header">
            ...
            <span class="card-action" onclick="window.location.href='timeline.php'">Full timeline →</span>
          </div>
          <div class="card-body">
      ...
      <div class="card" style="margin-bottom:0">
        <div class="card-header">
          ...
          <span class="card-action" onclick="window.location.href='tasks.php'">Manage tasks →</span>
        </div>
        <div class="card-body">
