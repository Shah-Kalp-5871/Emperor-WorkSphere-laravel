<header class="topbar">
  <div class="topbar-left">
    <span class="page-title"><?php echo $pageTitle ?? 'Dashboard'; ?></span>
    <span class="date-chip">Tuesday, 24 Feb 2026</span>
  </div>
  <div class="topbar-actions">
    ...
    <button class="icon-btn">
      ...
      <div class="topbar-avatar" onclick="window.location.href='my-profile.php'" style="cursor: pointer;">AR</div>
  </div>
</header>
