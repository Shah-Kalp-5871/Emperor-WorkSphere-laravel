...
@section('title', 'Anonymous Chat — WorkSphere')
...
<div class="chat-container" style="animation: fadeUp 0.4s ease-out; display: flex; flex-direction: column; height: calc(100vh - 120px);">
    ...
    <div style="margin-bottom: 24px;">
        <h1 style="font-family: 'Instrument Serif', serif; font-size: 32px; font-weight: 400;">Anonymous Chat</h1>
    ...
    <div class="message-feed" id="messageFeed" style="flex: 1; overflow-y: auto; padding-right: 10px; display: flex; flex-direction: column; gap: 16px; margin-bottom: 24px;">
        ...
        <div class="message-bubble">
            <div class="message-content">Does anyone know where the final draft of the Q1 roadmap is stored?</div>
            <div class="message-time">10:30 AM</div>
        </div>
        
        <div class="message-bubble">
            <div class="message-content">It's in the Shared Drive under Projects > 2026 > Planning.</div>
            <div class="message-time">10:45 AM</div>
        </div>

        <div class="message-bubble">
            <div class="message-content">Great work on the new ticket system, team! It makes things so much easier.</div>
            <div class="message-time">11:15 AM</div>
        </div>

        <div class="message-bubble" style="background: var(--accent-lt); border-color: var(--accent);">
            <div class="message-content">Does anyone want to grab coffee later? ☕</div>
            <div class="message-time">12:30 PM</div>
        </div>
        
        <div class="message-bubble">
            <div class="message-content">I'm having some trouble with the git merge on the auth-v2 branch. Anyone free to jump on a huddle later?</div>
