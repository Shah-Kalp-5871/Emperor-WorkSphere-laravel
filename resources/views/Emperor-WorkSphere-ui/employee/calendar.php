      ...
      <div class="panel calendar-panel">
        ...
        <div class="calendar-grid">
          ...
          for ($d = 1; $d <= $daysInMonth; $d++) {
            ...
            // Event markers
            if ($d == 10) echo '<div class="event-tag blue">Sprint Planning</div>';
            if ($d == 14) echo '<div class="event-tag red">Holiday</div>';
            if ($d == 24) {
              echo '<div class="event-tag green">Client Demo</div>';
              echo '<div class="event-tag amber">Daily Standup</div>';
            }
            if ($d == 27) echo '<div class="event-tag red">Project Deadline</div>';
